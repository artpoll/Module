...
class FormularioArticulos():
    def __init__(self):
        ...
        self.ventana1.title("Obras publicas")
    ...
    def carga_datos(self):
        ...
        self.label1=ttk.Label(self.labelframe1, text="Fecha Obra : ")
    ...
    def consulta_por_dato(self):
        ...
        self.label3=ttk.Label(self.labelframe2, text="Fecha Obra :")        
    ...
    def consultar(self):
        ...
        if respuesta:
            ...
            mb.showinfo("Información", "No existe un dato con dicho Id")
        
    def listado_datos(self):
        self.pagina3 = tk.Frame(self.cuaderno1)
        self.cuaderno1.add(self.pagina3, text="Listado completo")
        self.labelframe3=tk.LabelFrame(self.pagina3, text="Artículo")
        self.labelframe3.grid(column=0, row=0, padx=5, pady=10)
        self.boton1=tk.Button(self.labelframe3, text="Listado completo", width=14, bd=5, background="green", 
                                  fg="white", command=self.listar)
    ...
    def listar(self):
        ...
        for fila in respuesta:
            self.scrolledtext1.insert(tk.END,"Id: "+str(fila[0])+"\nName: "+fila[1]+
                                      "\nLast Name: "+str(fila[2])+"\nBirthdate: "+str(fila[3])+
                                      "\nPath: "+str(fila[2])+"\n\n")
